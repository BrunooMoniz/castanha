...
# Move uma gravação para outra reunião (ou para uma nova); as duas são refeitas
castanha recordings move <slug> <arquivo> --to=<outro-slug>
castanha recordings move <slug> <arquivo> --new-title="Conversa avulsa"

# Vincula uma reunião gravada na mão ao evento da agenda daquele dia
castanha agenda --dia 2026-09-12
castanha link-event <slug> <uid-do-evento>
```
